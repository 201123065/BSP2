...
public final class admin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <script>\n");
      out.write("\n");
      out.write("function processUser(files) {\n");
      out.write("    var file = files[0];\n");
      out.write("    var reader = new FileReader();\n");
      out.write("    reader.onload = function (e) {\n");
      out.write("        var output = document.getElementById(\"fileOutput\"); \n");
      out.write("        output.textContent = pruebaCarga(e.target.result,\"usuario_csv\");\n");
      out.write("    };\n");
      ...
      out.write("                    \n");
      out.write("                    <td><input id=\"fileInput\" type=\"file\" size=\"50\" onchange=\"processUser(this.files)\"></td>\n");
      ...
      out.write("<script>\n");
      out.write("    \n");
      out.write("        function pruebaCarga(str,url){\n");
      out.write("            $.ajax({\n");
      out.write("                data:{\n");
